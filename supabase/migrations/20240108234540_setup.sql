...
AS $$
DECLARE
  project_url TEXT := 'https://rmfercudwoxcphwgtfng.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJtZmVyY3Vkd294Y3Bod2d0Zm5nIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTg0MzYxNywiZXhwIjoyMDIxNDE5NjE3fQ.uKXfgN8aIgUa2Uef6sRefC6wQELKnUXIt8RmBgkZGzE'; -- full access needed for http request to storage
